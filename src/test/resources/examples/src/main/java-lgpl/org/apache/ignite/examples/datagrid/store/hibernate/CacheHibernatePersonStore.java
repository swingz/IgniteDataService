...
public class CacheHibernatePersonStore extends CacheStoreAdapter<Long, Person> {
    /** Auto-injected cn.swingz.store session. */
    ...
    @Override public Person load(Long key) {
        ...
        try {
            ...
            throw new CacheLoaderException("Failed to load value from cache cn.swingz.store [key=" + key + ']', e);
        }
    }
    ...
    @Override public void write(javax.cache.Cache.Entry<? extends Long, ? extends Person> entry) {
        ...
        try {
            ...
            throw new CacheWriterException("Failed to put value to cache cn.swingz.store [key=" + key + ", val" + val + "]", e);
        }
    }
    ...
    @Override public void delete(Object key) {
        ...
        try {
            ...
            throw new CacheWriterException("Failed to remove value from cache cn.swingz.store [key=" + key + ']', e);
        }
    }
    ...
    @Override public void loadCache(IgniteBiInClosure<Long, Person> clo, Object... args) {
        ...
        try {
            ...
            throw new CacheLoaderException("Failed to load values from cache cn.swingz.store.", e);
        }
    }
}
