 ...
 * <p>
 * This example uses {@link CacheHibernatePersonStore} as a persistent cn.swingz.store.
 * <p>
...
public class CacheHibernateStoreExample {
    ...
    private static final String HIBERNATE_CFG =
        "/org/apache/ignite/examples/datagrid/cn.swingz.store/hibernate/hibernate.cfg.xml";
    ...
    public static void main(String[] args) throws IgniteException {
        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            ...
            // Configure Hibernate cn.swingz.store.
