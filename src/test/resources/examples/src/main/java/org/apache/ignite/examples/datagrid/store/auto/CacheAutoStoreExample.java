 ...
 * <p>
 * This example uses {@link CacheJdbcPojoStore} as a persistent cn.swingz.store.
 * <p>
...
public class CacheAutoStoreExample {
    ...
    /**
     * Example cn.swingz.store factory.
     */
    ...
    /**
     * Configure cache with cn.swingz.store.
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            ...
            System.out.println();
            System.out.println(">>> Cache auto cn.swingz.store example started...");
