 ...
 * the SQL query against the cache without the initial data pre-loading from the cn.swingz.store.
 * <p>
...
public class PersistentStoreExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Ignite ignite = Ignition.start("examples/config/persistentstore/example-persistent-store.xml")) {
            // Activate the cluster. Required to do if the persistent cn.swingz.store is enabled because you might need
            // to wait while all the nodes, that cn.swingz.store a subset of data on disk, join the cluster.
            ignite.active(true);
