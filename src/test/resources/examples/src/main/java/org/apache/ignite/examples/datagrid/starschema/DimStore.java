...
/**
 * Represents a physical cn.swingz.store location. In our {@code snowflake} schema a {@code cn.swingz.store}
...
public class DimStore {
    ...
    /**
     * Constructs a cn.swingz.store instance.
     *
     * @param id Store ID.
